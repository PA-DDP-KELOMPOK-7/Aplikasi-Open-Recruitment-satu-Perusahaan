...
def invoice(id,pin,layanan):         #Invoice
    print(80 * "-")
...
def pembayaran_gopay():
    try:
        ...
        clear()
        invoice(nomor_id["gopay"],pin_["gopay"],"goPay")
        time.sleep(10)
    except ValueError:
...
def pembayaran_dana():
    try:
        ...
        clear()
        invoice(nomor_id["dana"],pin_["dana"],"Dana")
        time.sleep(10)
    except ValueError:
        print("Bukan angka yang kamu masukan")
        delay()
...
4. Exit """)
        ...
        if pilih_bank in ['1', '2', '3']:
            ...
            clear()
            invoice(nomor_id["m-banking"], pin_["m-banking"], bank_names[pilih_bank])
            time.sleep(10)
